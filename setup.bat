...
copy start.bat "%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup\jintai-agent.bat" >nul 2>&1
if %errorlevel% equ 0 (
...
echo.
echo Next steps:
echo 1. Double-click start.bat to run server
echo 2. Open browser: http://localhost:8001
echo 3. Click Settings icon and enter your API key
echo.
echo To stop server: Task Manager - find "pythonw.exe" - End Task
echo.
pause
